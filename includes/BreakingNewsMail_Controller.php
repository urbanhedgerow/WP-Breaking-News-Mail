...
// end pages_dropdown()
    ...
    function bnm_load_jquery() {
        ...
        wp_register_style('jquery-ui-style', apply_filters('bnm_jqueryui_css', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/themes/ui-darkness/jquery-ui.css'));
